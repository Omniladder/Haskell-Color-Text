...
/* package Haskell-Text-Display-0.1.0.0 */
#ifndef VERSION_Haskell_Text_Display
#define VERSION_Haskell_Text_Display "0.1.0.0"
#endif /* VERSION_Haskell_Text_Display */
#ifndef MIN_VERSION_Haskell_Text_Display
#define MIN_VERSION_Haskell_Text_Display(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Haskell_Text_Display */
...
#define CURRENT_COMPONENT_ID "Haskell-Text-Display-0.1.0.0-inplace-Haskell-Text-Display"
